...
public class GoodsInfo {
    ...
    private static int[] mThumbArray = {
            ...
            R.drawable.pink_s, R.drawable.f_s, R.drawable.xs2_s,R.drawable.xs2_s,R.drawable.lh_s,
    };
    // 声明一个手机商品的大图数组
    private static int[] mPicArray = {
            R.drawable.black, R.drawable.red, R.drawable.black2,
            R.drawable.pink, R.drawable.foundation, R.drawable.xs2,R.drawable.xs2,R.drawable.lh,
    };
